 ...
 *
 * NOTE: This software has been modified by WebGroup Media, LLC.
 *       It was required to remove all warnings for compiling and
 *       some minor other changes.
 * 
 * $Id: cdict.h,v 1.2 2003/06/21 18:37:20 bhalsted Exp $
 * $Name:  $
 */
